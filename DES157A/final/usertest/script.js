(function(){
    ...
    alert("Hello tester! This project is based on Pig's game!");
    alert("There's still one thing is unfinished, which is the pyramid building animation in the middle of the website. Nevermind, they are just decorations. The version right now may seems kind of blank.")
    alert("Before entering the game, you can change the name of the players, and choose the theme color. You'll see what will these options affect!");
    alert("When entering the game, you can see the menu on the top. Try to hover over it, and see how each options work by clicking them.");
    alert("After you check all the options, please try to win the game once and go back to the title. Then our test is finished!")
    ...
    changePlayerInfo.addEventListener('click', function(){
        ...
        document.getElementById('quitChange').addEventListener('click', function(){
